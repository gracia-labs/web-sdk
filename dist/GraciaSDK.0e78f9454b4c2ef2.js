...
`;var ns="gracia-player-default-styles",kr=ss.replace('url("./assets/GolosText-Regular.woff2")',`url("${is}")`);function Jt(s){if(typeof document>"u")return;let e=typeof ShadowRoot<"u"&&s instanceof ShadowRoot?s:s?.head??document.head;if(e.querySelector(`#${ns}`))return;let t=document.createElement("style");t.id=ns,t.textContent=kr,e.appendChild(t)}function j(...s){let e=[];for(let t of s)if(t){if(typeof t=="string"){e.push(t);continue}for(let[r,i]of Object.entries(t))i&&e.push(r)}return e.join(" ")}function ae(s){return s.label??s.displayName??s.id??s.url??"Untitled"}function Ir(s){return!Number.isFinite(s)||s<0?"0:00":`${Math.floor(s/60)}:${String(Math.floor(s%60)).padStart(2,"0")}`}function ye(s){return s instanceof Error?s:new Error(String(s))}function os(s,e){return{event:(t,r)=>s?.event?.(t,r),error:(t,r)=>{s?.error?.(t,r),e?.(t,r)}}}import{jsx as as,jsxs as Jn}from"react/jsx-runtime";var re=({variant:s="primary",className:e,type:t="button",children:r,...i})=>{let n=Array.isArray(s)?s:[s];return as("button",{type:t,className:j("gr-player__button",...n.map(a=>`gr-player__button--${a}`),e),...i,children:r})},Me=({variant:s="icon",srLabel:e,children:t,...r})=>Jn(re,{variant:s,...r,children:[t,e&&as("span",{className:"gr-player__sr",children:e})]});import{jsx as ut,jsxs as eo}from"react/jsx-runtime";var Ve=({icon:s,title:e,body:t,detail:r,action:i,className:n,role:a,ariaLive:o})=>ut("div",{className:n,role:a,"aria-live":o,children:eo("div",{className:"gr-player__state-message",children:[ut("div",{className:"gr-player__state-icon",children:s}),ut("h2",{children:e}),ut("p",{children:t}),r&&ut("span",{className:"gr-player__sr",children:r}),i]})});import{jsx as ls}from"react/jsx-runtime";var Fr=({message:s})=>ls("div",{className:"gr-player__error",role:"alert",children:ls("span",{className:"gr-player__error-text",children:s})});import{jsx as cs}from"react/jsx-runtime";var Br=({title:s,body:e,detail:t,action:r})=>cs(Ve,{icon:cs(Yi,{}),title:s,body:e,detail:t,action:r,className:"gr-player__error-screen",role:"alert",ariaLive:"assertive"});import{jsx as hs}from"react/jsx-runtime";var zr=()=>hs("div",{className:"gr-player__loader",role:"status","aria-live":"polite",children:hs("div",{className:"gr-player__spinner"})});import{forwardRef as oa,useImperativeHandle as aa,useRef as Us}from"react";import{createContext as to,useContext as ro}from"react";var ps=to(null),Gr=ps.Provider,F=()=>{let s=ro(ps);if(!s)throw new Error("usePlayerContext must be used within a PlayerProvider");return s};import{useEffect as us,useRef as io,useState as so}from"react";function Or(s,e,t){let[r,i]=so(!1);us(()=>{let o=s.current;if(!o)return;let l=()=>i(!0),c=h=>{h.touches.length>1&&l()};return o.addEventListener("pointerdown",l),o.addEventListener("wheel",l),o.addEventListener("touchmove",c),()=>{o.removeEventListener("pointerdown",l),o.removeEventListener("wheel",l),o.removeEventListener("touchmove",c)}},[s]);let n=io(e);return us(()=>{n.current!==e&&(n.current=e,i(!1))},[e]),{hasInteracted:r,resetView:()=>{t.reset(),i(!1)}}}import{useEffect as no,useState as oo}from"react";var ao=500;function Nr(s,e=ao){let[t,r]=oo(!1);return no(()=>{if(!s){r(!1);return}let i=setTimeout(()=>r(!0),e);return()=>clearTimeout(i)},[s,e]),s&&t}import{useEffect as lo,useRef as co,useState as ho}from"react";var po=2e3;function Xr({coreError:s,interactionError:e,isSceneReady:t,currentSource:r,open:i,clearError:n}){let[a,o]=ho(null),l=co(new WeakMap);e?.phase&&l.current.set(e.error,e.phase);let c=s&&e?.error===s?e.phase:s?l.current.get(s):void 0,h=s?{error:s,phase:c}:e,p=h?rs(h.error,t,h.phase):null,u=p?.presentation==="blocking",d=p?.presentation==="toast"&&p.cause!==a?p:null,f=d?.cause??null;return lo(()=>{if(!f)return;let x=setTimeout(()=>{o(f),n()},po);return()=>clearTimeout(x)},[f,n]),{playerError:p,isBlocking:!!u,toast:d,retry:()=>r?i(r):window.location.reload(),dismiss:()=>{d&&o(d.cause),n()}}}import{useCallback as uo,useEffect as fo,useState as mo}from"react";function Dr(s,e){let[t,r]=mo(!1),i=uo(async()=>{let n=s.current;if(!(!n||typeof document>"u"))try{document.fullscreenElement===n?await document.exitFullscreen():await n.requestFullscreen()}catch(a){e(ye(a),{phase:"fullscreen"})}},[e,s]);return fo(()=>{if(typeof document>"u")return;let n=()=>r(document.fullscreenElement===s.current);return n(),document.addEventListener("fullscreenchange",n),()=>document.removeEventListener("fullscreenchange",n)},[s]),{isFullscreen:t,toggleFullscreen:i}}import{useRef as go}from"react";function ds(s){let e=Ar(s.name);return{url:`${Kt}${s.name}`,label:s.name,file:s,...e?{type:Ki}:{}}}async function yo(s){return Ar(s.name)?ds(await s.getFile()):{url:`${Kt}${s.name}`,label:s.name,localFile:s}}function xo(){return typeof window>"u"?null:window.showOpenFilePicker??null}function bo(s){return s instanceof DOMException&&s.name==="AbortError"}function vo(s){let e=s.currentTarget.files?.[0];return s.currentTarget.value="",e?ds(e):null}function Hr({localFiles:s,logger:e,reportError:t,playlist:r,clearError:i}){let n=go(null),a=!!s,o=h=>{i();let p=[...r.sources,h];r.setSources(p),r.goTo(p.length-1),e.event?.("local_file_open",{label:ae(h)})};return{enabled:a,fileInputProps:{ref:n,accept:Qi,onChange:h=>{let p=vo(h);p&&o(p)}},localLabel:$i,openLocalFile:async()=>{if(!a)return;let h=xo();if(!h){n.current?.click();return}try{let u=(await h({types:[{description:"Volumetric video",accept:{"application/octet-stream":[...Rr]}}]}))[0];u&&o(await yo(u))}catch(p){bo(p)||t(ye(p),{phase:"local-file"})}}}}import{useRef as Vr}from"react";function Ur(s){let{containerRef:e,muted:t=!1,moduleFactory:r,overlay:i,eventLogger:n,onReady:a,onProgress:o,onModeChange:l,onXRStart:c,onXREnd:h}=s,p=Vr({onReady:a,onProgress:o,onModeChange:l,onXRStart:c,onXREnd:h});p.current={onReady:a,onProgress:o,onModeChange:l,onXRStart:c,onXREnd:h};let u=Vr(null),d=Vr(!1),f=Wt({containerRef:e,moduleFactory:r,moduleUrl:r?void 0:es(),overlay:i,eventLogger:n,onReady(){d.current||(d.current=!0,t||u.current?.app?.enableAudio()),p.current.onReady?.()},onProgress:m=>p.current.onProgress?.(m),onModeChange:(m,x)=>p.current.onModeChange?.(m,x),onXRStart:()=>p.current.onXRStart?.(),onXREnd:()=>p.current.onXREnd?.()});u.current=f;let g=Yt(f);return{gracia:f,playlist:g}}import{useCallback as Wr,useMemo as fs,useState as _o}from"react";function wo(s){switch(s){case"init":case"load":case"xr":case"streaming":case"fullscreen":case"local-file":return s;default:return}}function Yr(s,e){let[t,r]=_o(null),i=fs(()=>os(s,e),[s,e]),n=Wr((c,h)=>{r({error:c,phase:wo(h?.phase)})},[]),a=fs(()=>({event:(c,h)=>i.event?.(c,h),error:(c,h)=>{n(c,h),i.error?.(c,h)}}),[i,n]),o=Wr((c,h)=>{n(c,h),i.error?.(c,h)},[i,n]),l=Wr(()=>r(null),[]);return{interactionError:t,logger:a,reportError:o,clearError:l}}import{useEffect as Wo}from"react";import{useEffect as So,useRef as To}from"react";function Zr({isInitialized:s,sources:e,streaming:t,playlist:r,reportError:i}){let n=To(i);n.current=i,So(()=>{if(!s)return;let a=!1,o=l=>{a||l.length===0||(r.setSources(l),r.goTo(0))};if(t?.length)return He(t,ts()).then(o).catch(l=>{a||n.current(ye(l),{phase:"streaming"})}),()=>{a=!0};o(e)},[s,e,t,r.setSources,r.goTo])}import{useEffect as Po,useRef as ms}from"react";function qr({currentSource:s,index:e,onSceneChange:t}){let r=ms(t);r.current=t;let i=ms(null);Po(()=>{if(!s||e<0)return;let n=`${e}:${ae(s)}`;i.current!==n&&(i.current=n,r.current?.(s,e))},[s,e])}import{useEffect as Mo,useState as Co}from"react";var Eo=500;function jr(s,e,t){let[r,i]=Co(!1),n=$t(s.mode)?s.mode:null;Mo(()=>{(!n||!s.xr.isActive)&&i(!1)},[n,s.xr.isActive]);let a=h=>{t(),i(!0),s.xr.setMode(h).catch(p=>{i(!1),e(ye(p),{phase:"xr",target:h})})},o=()=>{i(!1),s.xr.setMode(oe.PW).catch(h=>{e(ye(h),{phase:"xr",target:oe.PW})})},c=Nr(r&&!s.error,Eo)&&s.xr.isActive?n:null;return{enter:a,exit:o,activeScreenMode:c}}import{signal as xe}from"@preact/signals-core";import{Container as U,Fullscreen as Io,Svg as Ae,Text as rr}from"@react-three/uikit";import{signal as Ce}from"@preact/signals-core";import{forwardHtmlEvents as Lo}from"@pmndrs/pointer-events";import{createRoot as Ro}from"@react-three/fiber";var er=class{#e;#r;#t;#i;#s;#o;#n=null;#a=null;#l;#h;#c=null;#p=null;#u=null;#g=!1;#f=!1;#d;#m;#y;#x;#b;#v;constructor(e,{pixelWidth:t,pixelHeight:r,worldWidth:i,worldHeight:n,cursorFactory:a,react:o=!1}){this.#s=e,this.#o=a,this.#g=o,this.#e=t*2,this.#r=r*2,this.#t=document.createElement("canvas"),this.#t.width=this.#e,this.#t.height=this.#r,this.#i=new e.WebGLRenderer({canvas:this.#t,alpha:!0,antialias:!0,premultipliedAlpha:!1,preserveDrawingBuffer:!0}),this.#i.setClearColor(0,0),this.#i.setSize(this.#e,this.#r,!1),this.#l=new e.Scene,this.#h=new e.OrthographicCamera(0,t,r,0,.1,10),this.#h.position.z=5,this.#d=new e.Raycaster,this.#m=new e.Vector3,this.#y=new e.Vector3,this.#x=new e.Quaternion,this.#b=new e.Mesh(new e.PlaneGeometry(i,n),new e.MeshBasicMaterial({visible:!1,side:e.DoubleSide}));let l=new e.SphereGeometry(.008,8,8),c=()=>new e.MeshBasicMaterial({color:65280,depthTest:!1});this.#v=[0,1].map(()=>{let h=new e.Mesh(l,c());return h.renderOrder=1001,h.visible=!1,h})}get canvas(){return this.#t}get scene(){return this.#l}get pixelWidth(){return this.#e/2}get pixelHeight(){return this.#r/2}get internalWidth(){return this.#e}get internalHeight(){return this.#r}get pointer(){return this.#n}get cursor(){return this.#a?.mesh??null}get ptrPressed(){return this.#f}get reactPending(){return this.#g}get hitMesh(){return this.#b}get hitSpheres(){return this.#v}async mountReact(e){this.#c=Ro(this.#t),await this.#c.configure({frameloop:"never",orthographic:!0,size:{width:this.#e/2,height:this.#r/2},dpr:2,gl:this.#i,events:()=>({enabled:!1,priority:0,handlers:{}})}),this.#p=this.#c.render(e),this.#l=this.#p.getState().scene,this.#u=Lo(this.#t,()=>this.#p.getState().camera,this.#l,{batchEvents:!1}),this.#g=!1}patchCanvasForXR(){let e=this.pixelWidth,t=this.pixelHeight;this.#t.getBoundingClientRect=()=>({x:0,y:0,left:0,top:0,right:e,bottom:t,width:e,height:t,toJSON(){}});let r=new Set;this.#t.setPointerCapture=i=>r.add(i),this.#t.releasePointerCapture=i=>r.delete(i),this.#t.hasPointerCapture=i=>r.has(i)}setPointer(e,t,r,i=!1){if(!this.#n){if(!this.#l)return;this.#n={x:e,y:t,pressed:r};let c=this.#o(this.#s);c.position.z=.06,this.#l.add(c),this.#a={mesh:c,sx:e,sy:this.pixelHeight-t}}let n=this.#n;n.x=e,n.y=t,n.pressed=r;let a=this.#a,o=this.pixelHeight-t,l=a.mesh.visible?.6:1;a.sx+=(e-a.sx)*l,a.sy+=(o-a.sy)*l,a.mesh.visible=!0,this.#p?a.mesh.position.set(a.sx-this.pixelWidth/2,a.sy-this.pixelHeight/2,.06):a.mesh.position.set(a.sx,a.sy,.06),a.mesh.material.opacity=r?1:.7,i&&this.#_(e,t,r)}clearPointer(e=!1){e&&this.#n&&this.#S(),this.#n=null,this.#a&&(this.#a.mesh.visible=!1)}renderScene(){this.#g||(this.#u?.update(),this.#p?this.#p.getState().advance(performance.now(),!0):this.#i&&this.#i.render(this.#l,this.#h))}clampAlpha(e){let t=this.#i.getContext();t.colorMask(!1,!1,!1,!0),t.clearColor(0,0,0,e),t.clear(t.COLOR_BUFFER_BIT),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0)}initFlat(){let e=!1,t=r=>{let i=this.#t.getBoundingClientRect();return{x:(r.clientX-i.left)/i.width*this.pixelWidth,y:(r.clientY-i.top)/i.height*this.pixelHeight}};this.#t.addEventListener("pointerdown",r=>{e=!0,this.#t.setPointerCapture(r.pointerId);let i=t(r);this.setPointer(i.x,i.y,!0)}),this.#t.addEventListener("pointermove",r=>{let i=t(r);this.setPointer(i.x,i.y,e)}),this.#t.addEventListener("pointerup",r=>{e=!1;let i=t(r);this.setPointer(i.x,i.y,!1)}),this.#t.addEventListener("pointerleave",()=>{e=!1,this.clearPointer()})}renderFlat(){this.#g||(this.#u?.update(),this.#p?this.#p.getState().advance(performance.now(),!0):this.#i&&this.#i.render(this.#l,this.#h))}castRay(e,t){let r=e.rayTransform.position,i=e.rayTransform.orientation;return this.#m.set(r.x,r.y,r.z),this.#y.set(0,0,-1).applyQuaternion(this.#x.set(i.x,i.y,i.z,i.w)),this.rayHitQuad(this.#m,this.#y,t)}rayHitQuad(e,t,r=0){let i=this.pixelWidth,n=this.pixelHeight,a=this.#v[r];this.#d.ray.origin.copy(e),this.#d.ray.direction.copy(t);let o=this.#d.intersectObject(this.#b);if(o.length===0)return a.visible=!1,null;let l=o[0].point,c=o[0].uv;if(!c)return a.visible=!1,null;let h=c.x*i,p=(1-c.y)*n;return h<0||h>i||p<0||p>n?(a.visible=!1,null):(a.position.copy(l),a.visible=!0,a.updateMatrixWorld(!0),{x:h,y:p})}gazeHitsQuad(e,t){if(!e?.transform)return!0;let r=e.transform.position,i=e.transform.orientation,n=-2*(i.w*i.y+i.x*i.z),a=-2*(i.y*i.z-i.w*i.x),o=2*(i.x*i.x+i.y*i.y)-1,l=t||this.#b.position,c=l.x-r.x,h=l.y-r.y,p=l.z-r.z,u=Math.sqrt(c*c+h*h+p*p)||1;return(n*c+a*h+o*p)/u>.6}dispose(){this.#u?.destroy(),this.#u=null,this.#c&&(this.#c.unmount(),this.#c=null,this.#p=null),this.#i?.dispose(),this.#i=null}#_(e,t,r){let i=this.#f;this.#f=r;let n={clientX:e,clientY:t,pointerId:1,pointerType:"mouse",isPrimary:!0};r&&!i&&this.#t.dispatchEvent(new PointerEvent("pointerdown",{...n,button:0,buttons:1,bubbles:!0})),this.#t.dispatchEvent(new PointerEvent("pointermove",{...n,buttons:r?1:0,bubbles:!0})),!r&&i&&this.#t.dispatchEvent(new PointerEvent("pointerup",{...n,button:0,buttons:0,bubbles:!0}))}#S(){let e={pointerId:1,pointerType:"mouse",isPrimary:!0};this.#f&&this.#t.dispatchEvent(new PointerEvent("pointerup",{...e,button:0,buttons:0,bubbles:!0})),this.#t.dispatchEvent(new PointerEvent("pointerleave",{...e,bubbles:!1})),this.#f=!1}};var Ao=`attribute vec2 a_pos;
varying vec2 v_uv;
uniform mat4 u_mvp;
void main() {
    v_uv = a_pos + 0.5;
